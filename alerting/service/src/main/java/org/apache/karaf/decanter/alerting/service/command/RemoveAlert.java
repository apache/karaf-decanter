 ...
 */
package org.apache.karaf.decanter.alerting.service.command;

import org.apache.karaf.decanter.alerting.service.Store;
import org.apache.karaf.decanter.alerting.service.command.completers.AlertUUIDCompleter;
...
@Service
@Command(scope = "decanter", name = "alert-remove", description = "Remove an alert from the alerting service")
